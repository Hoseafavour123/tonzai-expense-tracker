    ...
    cron.schedule(
      ...
      async () => {
          ...
          .text(
            `${
              totalExpenses > totalIncome
                ...
                : totalExpenses !== totalIncome ? 'Your income for the week was more than your expenses, keep up making wiser financial decisions' :'You have not logged any transaction.'
            }`
          )
        ...
        sendMail({
          ...
          .then(() => console.log('weekly report sent'))
